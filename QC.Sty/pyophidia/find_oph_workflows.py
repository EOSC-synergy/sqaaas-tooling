...
def get_input_args():
    ...
    parser.add_argument("--path",metavar='PATH',type=str,help='path to look for in the repository')
...
def evaluate_workflow(candidates):
    ...
    for jsons in candidates:
        ...
        results={"result":passed,"passed_list":passed_list,"failed_list":failed_list}
    return(results)
